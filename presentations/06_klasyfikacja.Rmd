...
Tworzenie modelu na całym zbiorze danych nie pozwala ocenić jego jakości w odniesieniu do nowych przypadków. W celu faktycznej oceny dokonuje się podziału zbioru danych na przynajmniej dwa rozłączne zbiory:
...
Bardzo wysoka wartość dokładność na zbiorze treningowym, a niska na zbiorze walidacyjnym jest symptomem przeuczenia modelu - algorytm nauczył się odpowiedzi "na pamięć".
